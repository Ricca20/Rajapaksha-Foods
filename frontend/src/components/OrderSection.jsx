...
export default function OrderSection() {
  ...
  const floatingCardVariants = {
    ...
    hover: { scale: 1.1, y: -15, transition: { duration: 0.3, ease: "easeOut" } },
  };
    ...
    <section className="relative overflow-hidden py-24 px-6 bg-white">
      ...
      >
        ...
        <div className="space-y-8 text-center lg:text-left">
          ...
          >
            <motion.button
              className="group flex items-center bg-orange-500 hover:bg-orange-600 text-white font-semibold px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
        ...
        <div className="relative flex justify-center lg:justify-end">
          ...
          >
            <motion.div
              className="absolute inset-0 rounded-full bg-gradient-to-tr from-orange-400 to-orange-600 opacity-20 blur-2xl"
              animate={{ rotate: 360 }}
            ...
            >
              ...
              <div className="w-72 h-72 bg-gradient-to-br from-orange-100 to-gray-100 rounded-full flex items-center justify-center">
          ...
          >
            <p className="text-sm font-semibold text-gray-800 flex items-center gap-2">
              ...
              <motion.span animate={{ opacity: [0.8, 1, 0.8] }} transition={{ duration: 2, repeat: Infinity, delay: 0.5 }}>
                4.5/5 Reviews
              </motion.span>
            </p>
          </motion.div>
          ...
          <motion.div
            className="absolute bottom-10 -right-10 bg-orange-500 text-white px-6 py-4 rounded-2xl shadow-xl z-20"
            variants={floatingCardVariants}
            animate="animate"
            whileHover="hover"
            transition={{ delay: 1 }}
