...
const MenuPage = () => {
  ...
  const calculateTotal = () => {
    let total = 0;
    if (selectedPrice === 'full') total += menu?.priceFull || 0;
    if (selectedPrice === 'half') total += menu?.priceHalf || 0;
          ...
          >
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                {[
                  { value: 'full', label: 'Full Portion', price: menu.priceFull },
                  { value: 'half', label: 'Normal Portion', price: menu.priceHalf }
                ].map(option => (
                  <motion.label
                    key={option.value}
